...
const direccionPaula = new Direction(
  "Calle Llave",
  15,
  8,
  "C",
...
const direccionElena = new Direction(
  "Calle Puertas",
  8,
  3,
  false,
...
const direccionAlvaro = new Direction(
  "Gran Vía",
  50,
  6,
  "A",
...
const nuevaDireccion = new Direction(
  "Avenida América",
  10,
  5,
  false,
...
const nuevoMail = new Mail("trabajo", "ep.martinez@outlook.com");
